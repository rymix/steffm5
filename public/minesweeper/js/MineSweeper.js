    ...
    this.getTemplate = function (template) {
      let templates = {
        settings:
          ...
          '<select id="level" class="msLevel"><option value="beginner">Beginner</option>' +
          '<option value="intermediate">Intermediate</option><option value="expert">Expert</option>' +
          '<option value="custom" style="display:none;">Custom</option></select>' +
          '<input type="text" id="dim_x" class="msDimX invisible" placeholder="x" size="5" disabled value="20" />' +
          '<input type="text" id="dim_y" class="msDimY invisible" placeholder="y" size="5" disabled value="20" />' +
          '<input type="text" id="numMines" class="msNumMines invisible" placeholder="mines" size="5" disabled />' +
          '</div>' +
